...
var iitem1View = document.getElementById('iitem1View')
var iitem2View = document.getElementById('iitem2View')
var iitem3View = document.getElementById('iitem3View')
var iitem4View = document.getElementById('iitem4View')
...
var iitemss = [iitem1View, iitem2View, iitem3View, iitem4View]
...
var ItemBody=document.getElementById('exampleModal')
    ...
    viewOrder.addEventListener('click', function(e){
        ...
        for(var i = 0; i < data.length; i++){
            if(data[i]['orNumber'] == orderNum){    
                ...
                for(var ii = 0; ii < data[i]['iitems'].length; ii++){
                    console.log(itemss[ii])
                    if(data[i]['iitems'][ii]['name'] != ''){
                        ...
                        image.src = data[i]['iitems'][ii]['thumbnail']
                        ...
                        var cardTxtNode = document.createTextNode(data[i]["iitems"][ii]["name"])
                        cardTitle.appendChild(cardTxtNode)
                        var cardPrice = document.createElement("p")
                        cardPrice.className = "card-text"
                        var priceTxtNode = document.createTextNode("Price: "+data[i]["iitems"][ii]["price"])
                        
                        cardPrice.appendChild(priceTxtNode)
                        var cardQty = document.createElement("p")
                        cardQty.className = "card-text"
                        var qtyTxtNode = document.createTextNode("Quantity: "+data[i]["iitems"][ii]["qty"])
